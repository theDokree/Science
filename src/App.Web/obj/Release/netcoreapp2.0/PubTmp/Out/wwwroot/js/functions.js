...
//    $('#sa-select-city').on('hidden.bs.modal', function () {
//        // remove the bs.modal data attribute from it
//        $(this).removeData('bs.modal');
//        // and empty the modal-content element
//        $('#sa-select-city .modal-content').empty();
//    });
//});
...
$(function () {
    ...
    function clickselectcity() {        
            $('#dialogContent').load("/Home/CitysModal/", function () {
                $('#sa-select-city').modal({
                    backdrop: 'static',
                    keyboard: true
                }, 'show');
                bindForm(this);
    ...
    function bindForm(dialog) {
        $('form', dialog).submit(function () {
            ...
            //if (localStore.CityId != '') {
            //    isFind = true;
            //}

            //if (!isFind) {
            //    //отправка запроса на просмотр
            //    localStore.pageNames.push(retrievedPageName);
            //    localStorage.setItem("localStore", JSON.stringify(localStore));

            //    $.ajax({
            //        url: '@Url.Action("NewsCountClicks", "News")',
            //        type: "POST",
            //        data: { id: retrievedPageName },
            //        dataType: "json",
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#_weather").html(result);
                    $('#sa-select-city').modal('toggle');
                },
                error: function (result) {
                   
                   
                    $('#sa-select-city').modal('toggle');
                    $("#_weather").html(result.responseText);
                }
            });
            return false;
        });
...
$(document).ready(function () {
    ...
    // Календарь виджет
    //--------------------------------------
    //$('#sa-select-city').click(function () {
    //    swal({
    //        title: "Выберите город!",
    //        text: "Наберите название города:",
    //        type: "input",
    //        showCancelButton: true,
    //        closeOnConfirm: false,
    //        inputPlaceholder: "Найти город"
    //    }, function (inputValue) {
    //        if (inputValue === false) return false;
    //        if (inputValue === "") {
    //            swal.showInputError("Вы не выбрали город!");
    //            return false
    //        }
    //        swal("Прекрасно!", "Вы выбрали город: " + inputValue, "success");
    //    });
    //});
    ...
    //    var container = $("#_weather");
    //    $.ajax({
    //        type: 'POST',
    //        url: '/Home/WeatherComponent',
    //        data: 'city = Москва',
    ...
    if ($('#calendar-widget')[0]) {
        ...
        var now = curr_year + "-" + curr_month + "-" + curr_date;
